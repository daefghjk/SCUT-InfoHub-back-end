...
&& apk add --update --no-cache python3 py3-pip gcc python3-dev py3-pipx\
&& rm -rf /var/cache/apk/*
...
# 安装依赖到指定的/install文件夹
# 选用国内镜像源以提高下载速度
RUN pipx config set global.index-url http://mirrors.cloud.tencent.com/pypi/simple \
&& pipx config set global.trusted-host mirrors.cloud.tencent.com \
